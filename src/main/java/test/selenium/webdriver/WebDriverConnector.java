...
import test.selenium.pater.IPaterContext;
import test.selenium.pater.Pater;
...
//				x.printStackTrace();
	...
	static public WebDriverConnector get() throws Exception {
		...
		if(StringUtils.isBlank(appURL) || appURL == null)
...
//			System.out.println("@onTestFailure: context = " + context);
	...
	public void verifyTextNotEmpty(@Nonnull String testid) {
		assertFalse("TestID " + testid + ": text is empty", StringUtils.isBlank(getHtmlText(testid)));
	}
